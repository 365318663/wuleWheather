...
public class SelectPhotoAdapterWithNoSelect extends ArrayAdapter<SelectPhotoAdapter.SelectPhotoEntity> implements OnClickListener {
    ...
    public SelectPhotoAdapterWithNoSelect(Activity activity, ArrayList<SelectPhotoAdapter.SelectPhotoEntity> array) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (position == allPhotoList.size()) {
            ...
            img.setLayoutParams(new RelativeLayout.LayoutParams(destWidth, destWidth));
...
//        } else
        if ((allPhotoList != null) && (position >= 0) && (allPhotoList.size() >= position) && (allPhotoList.get(position) != null)) {
            ...
            viewHolder.rlPhoto.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
